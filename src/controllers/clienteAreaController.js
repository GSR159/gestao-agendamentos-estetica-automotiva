...
/**
 * FIX #3: Busca cliente por ID do token ao invés de email
...
/**
 * FIX #2: Usar cliente_id do token ao invés de email
...
/**
 * FIX #3: Valida data_nascimento antes de atualizar
 * Previne manipulação de desconto de aniversário
 */
const atualizarConta = async (req, res) => {
  ...
  try {
    // FIX #3: Validar data de nascimento
    if (data_nascimento) {
